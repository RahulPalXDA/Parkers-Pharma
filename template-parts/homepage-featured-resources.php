...
<section class="education-resource-sec">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="cntn-box">
                    <div class="global-header">
                        <h5><?php echo esc_html(get_field('resources_section_name')); ?></h5>
                        <h2><?php echo esc_html(get_field('resources_section_heading')); ?></h2>
                        <p><?php echo esc_html(get_field('resources_section_description')); ?></p>
                        <?php
                        $resources_cta_link = get_field('resources_section_cta');
                    ...
                    <?php
                    $section_featured_image = get_field('resources_section_featured_image');
            ...
            <?php $section_side_image = get_field('resources_section_side_image');
