...
<section class="comprehensive-solutions-sec">
    <div class="custom-container">
        <div class="global-header">
            <h5><?php echo esc_html(get_field('solution_section_name')); ?></h5>
            <h2><?php echo esc_html(get_field('solutions_section_heading')); ?></h2>
        </div>
        <?php if (have_rows('solution_section_cards')): ?>
            <div class="row">
                <?php while (have_rows('solution_section_cards')):
                    the_row(); ?>
