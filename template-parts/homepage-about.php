        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="image-box">
                    <div class="global-header">
                        <h5><?php echo esc_html(get_field('about_section_name')); ?></h5>
                        <h2><?php echo esc_html(get_field('about_section_title')); ?></h2>
                    </div>
                    <?php
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="content-box">
                    <p><?php echo esc_html(get_field('about_section_desctiption')); ?></p>
                    <?php
                    $about_cta_link = get_field('about_section_cta');
                    if ($about_cta_link):
                    ...
                    <?php endif; ?>
                    <?php if (have_rows('about_section_counter')): ?>
                        <div class="abt-feature-cards">
                            <?php while (have_rows('about_section_counter')):
                                the_row(); ?>
                                <div class="abt-card">
