        ...
        <div class="custom-container">
            <ul class="call-us-box">
                ...
                if( $topbar_link ): 
                    ...
                    ?>
                    <a href="<?php echo esc_url( $topbar_link_url ); ?>" target="<?php echo esc_attr( $topbar_link_target ); ?>"><?php echo esc_html( $topbar_link_title ); ?></a>
                <?php endif; ?>
            </ul>
        </div>
    </section>
    ...
    <nav class="top-navbar navbar navbar-expand-lg" id="topNavBar">
        <div class="custom-container">
            <div class="navbar-wrapper">
                <a class="navbar-brand top-logo-part" href="#"><?php the_custom_logo(); ?></a>
                ...
                <div class="collapse navbar-collapse" id="navbar-content">
                    ...
                    <div class="conatact-btn">
                        ...
                        if( $header_button_link ): 
                            ...
                            ?>
                            <a class="global-solid-button" href="<?php echo esc_url( $header_button_link_url ); ?>" target="<?php echo esc_attr( $header_button_link_target ); ?>"><?php echo esc_html( $header_button_link_title ); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
